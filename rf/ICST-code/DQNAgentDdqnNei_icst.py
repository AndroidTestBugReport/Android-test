...
class DQNAgentClass:
    ...
    def _buildQ(self):
        ...
        actionDict["back"]=1
        actionDict["click"]=2
        actionDict["longclick"]=3
        actionDict["text"]=4
        actionDict["swipe"]=5
        actionDict["contextual"]=6
    ...
    def replay(self, batch_size, lastStateStepNum, Feature2Digit, word2VecModel,word2Idx, testLastTuple, recordMiddleList, sameBefore, iterCount, iteTime):
