...
def main():
                        ...
                        if "beforeModle:" in line:
                            ...
                            if bothVal:
                                ...
                                for indexTotal1 in range(len(record)):
                                    if record[indexTotal1]==min(record):
                                        midRight+=1
                                    else:
                                        midWrong+=1
                                
                                totoalRightModi+=1*float(midRight)/float(midRight+midWrong)
                                totoalModi+=1
                    ...
                    for line in contents:####for first child has and first child has no
                        ...
                        if "beforeModle:" in line:
                            ...
                            if bothValNotEquZe and not neiAllzero and neiHasZero:
                                ...
                                rightChildNeiMod1+=1*float(midRight)/float(midRight+midWrong)
                                totalChildNeiMod1+=1
    ...
    print("totoalRightModi: "+str(totoalRightModi))   
    print("totoalModi: "+str(totoalModi))    
    
    
    print("totalRight1: "+str(totalRight1))   
    print("totalWrong1: "+str(totalWrong1))    
    print("totalEvent1: "+str(totalEvent1))
    ...
    print("#############")
    print("rightChildNeiMod1: "+str(rightChildNeiMod1))   
    print("totalChildNeiMod1: "+str(totalChildNeiMod1))     
